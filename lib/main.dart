...
import 'package:buck_demo/menus/bundle_deliver.dart';
...
import 'package:buck_demo/menus/bundle_service.dart';
import 'package:buck_demo/menus/bundle_shopping.dart';
...
const LOGIN_API = '/authority/guest/app_login';
...
Future<void> main() async {
  ...
  buck.installMenus('Beta', [BundleService(), BundleShopping(), BundleDeliver(key: Key('c-Deliver'))]);
